...
export type QueryServiceQuery = { __typename?: 'Query' } & {
  queryService: { __typename?: 'ExecResp' } & Pick<ExecResp, 'isError' | 'ret'>;
};
...
export type SendTransactionMutation = { __typename?: 'Mutation' } & Pick<
  Mutation,
  'sendTransaction'
>;
...
export type GetTransactionQuery = { __typename?: 'Query' } & {
  getTransaction: { __typename?: 'SignedTransaction' } & Pick<
    SignedTransaction,
    | 'nonce'
    | 'chainId'
    | 'cyclesLimit'
...
export type GetReceiptQuery = { __typename?: 'Query' } & {
  getReceipt: { __typename?: 'Receipt' } & Pick<
    Receipt,
    'txHash' | 'height' | 'cyclesUsed' | 'stateRoot'
  > & {
      events: Array<{ __typename?: 'Event' } & Pick<Event, 'data' | 'service'>>;
      response: { __typename?: 'ReceiptResponse' } & Pick<
        ReceiptResponse,
        'serviceName' | 'method' | 'ret' | 'isError'
      >;
    };
};
...
export type GetBlockQuery = { __typename?: 'Query' } & {
  getBlock: { __typename?: 'Block' } & Pick<Block, 'orderedTxHashes'> & {
      header: { __typename?: 'BlockHeader' } & Pick<
        BlockHeader,
        | 'chainId'
        | 'confirmRoot'
        | 'cyclesUsed'
      ...
      > & {
          ...
          validators: Array<
            { __typename?: 'Validator' } & Pick<
              Validator,
              'address' | 'proposeWeight' | 'voteWeight'
            >
          >;
        };
    };
...
export function getSdk(client: GraphQLClient) {
  return {
    queryService(
      ...
      return client.request<QueryServiceQuery>(
    ...
    sendTransaction(
      ...
      return client.request<SendTransactionMutation>(
    ...
    getTransaction(
      ...
      return client.request<GetTransactionQuery>(
        print(GetTransactionDocument),
        variables
      );
    },
    getReceipt(variables: GetReceiptQueryVariables): Promise<GetReceiptQuery> {
      return client.request<GetReceiptQuery>(
        print(GetReceiptDocument),
        variables
      );
    },
